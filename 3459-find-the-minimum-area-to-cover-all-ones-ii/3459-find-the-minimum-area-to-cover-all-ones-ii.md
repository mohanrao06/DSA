<h1>3459 - Find the Minimum Area to Cover All Ones II</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/find-the-minimum-area-to-cover-all-ones-ii/">find-the-minimum-area-to-cover-all-ones-ii</a></h2><p>You are given a 2D <strong>binary</strong> array <code>grid</code>. You need to find 3 <strong>non-overlapping</strong> rectangles having <strong>non-zero</strong> areas with horizontal and vertical sides such that all the 1&#39;s in <code>grid</code> lie inside these rectangles.</p>
