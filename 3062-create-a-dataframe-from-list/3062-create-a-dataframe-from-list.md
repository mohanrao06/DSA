<h1>3062 - Create a DataFrame from List</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/create-a-dataframe-from-list/">create-a-dataframe-from-list</a></h2><p>Write a solution to <strong>create</strong> a DataFrame from a 2D list called <code>student_data</code>. This 2D list contains the IDs and ages of some students.</p>
