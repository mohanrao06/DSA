<h1>3277 - Find the Number of Ways to Place People II</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/find-the-number-of-ways-to-place-people-ii/">find-the-number-of-ways-to-place-people-ii</a></h2><p>You are given a 2D array <code>points</code> of size <code>n x 2</code> representing integer coordinates of some points on a 2D-plane, where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>.</p>
