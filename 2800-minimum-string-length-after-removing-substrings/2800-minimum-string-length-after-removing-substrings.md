<h1>2800 - Minimum String Length After Removing Substrings</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/minimum-string-length-after-removing-substrings/">minimum-string-length-after-removing-substrings</a></h2><p>You are given a string <code>s</code> consisting only of <strong>uppercase</strong> English letters.</p>
